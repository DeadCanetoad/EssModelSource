...
{$endif}
    ...
    procedure SetDiSave(const Value: TDiSaveSetting);
  ...
  public
    ...
    property DiSave : TDiSaveSetting read FDiSave write SetDiSave;
...
procedure TConfig.SetDiSave(const Value: TDiSaveSetting);
begin
  if Value<>FDiSave then
  begin
    FDiSave := Value;
{$ifdef WIN32}
