...
type
  ...
  private
    procedure NeedPackageHandler(const AName: string; var AStream: TStream);
  public
...
procedure TJavaImporter.NeedPackageHandler(const AName: string; var AStream: TStream);
var
  FileName: string;
begin
  AStream := nil;
  ...
  if (FileName<>'') and (FilesRead.IndexOf(FileName)=-1) then
  begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          //Attributes
          //**interface kan ha konstant attribut, detta stöds ej av vår modell
          DoAttribute( TempA , TypeName);
          while Token = ',' do
          begin
            DoAttribute( TempA , TypeName);
            GetNextToken;
