...
//Följande deklarationer behövs för att hjälpa till essconnectpanel att
//fånga alla musactions. Alla controls som infogas (klassnamn etc) i
//rtfdbox får sina mousedown omdefinierade.
type
...
begin
  inherited;
  //Owner=Self måste testas eftersom notifikationer skickas för alla komponenter i
  //hela formuläret, även ovanför denna. TRtfdLabels skapas med owner=box.
...
begin
  ...
  FTransparent := True;
  //Top måste sättas så att alla labels lägger sig under varandra när align=top
  Top := MaxInt;
end;
