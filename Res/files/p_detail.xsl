...
<!-- parameter ar id pa det paket vi skall generera html for-->
...
<!-- Interface som en class implementerar -->
...
<!-- Klasser som implementerar ett interface -->
